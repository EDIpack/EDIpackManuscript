...
their spin-dependent impurity and bath parts as $\ket{I} = \ket{
  i_\uparrow\,  b_\uparrow\, i_\downarrow \, b_\downarrow}$. Each bitset 
span a space of dimension $D^\a_{imp}$ or $D^\s_{bath}$. 
...
$j\in[1,\dots,D^\s_{bath}]$ (\emph{values}) that satisfy the conservation law defined
...
%GBtodo placeholder: revise this subsection from this point onwards
\paragraph{{\bf normal}}
...
only {\color{red} diagonal} terms in the {\bf normal} case. {\color{red} [GB: this is a wrong statement: do you mean \emph{spin-}diagonal?]}
