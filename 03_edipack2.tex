...
\fixme{Destruction and creation operators, $c_{a\sigma}$ and $c^+_{a\sigma}$ 
...
To mitigate the exponential scaling of the \fixme{Fock space dimension}, it 
...
The third column report the dimension of the electronic symmetry sector $\SS_{\vec{Q}}$ for a
...
\fixme{Again: this discussion is only for the electronic part. We need to state we focus on that here and discuss the modifications requied to deal with phonons at the end of this section}
