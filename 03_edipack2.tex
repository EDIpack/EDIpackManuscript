...
within a given symmetry sector $\SS_{\vec{Q}}$ to the Fock states $\ket{I_e}$ in the electronic Fock space in their number representation~\cite{Wallerberger2022PRR}. 
