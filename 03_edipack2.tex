...
%GBtodo placeholder: revise this subsection
\subsection{Reduced impurity density matrix}\label{sSecRDM}
This version of the \NAME library features the calculation of the
impurity Reduced Density Matrix (iRDM), extending the algorithm introduced in \onlinecite{BellomiaPhD} so to enable the analysis of
