...
The codes,the data and the script to generate the figures presented here can be found in the repository \href{https://github.com/EDIpack/EDIpack2examples}{github.com/EDIpack/EDIpack2examples}.  
...
//Locally defined functions: de = 2*D/Le
