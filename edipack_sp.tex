...
EDIpack 2.0 \textcolor{red}{are we sure about 2.0? current version is 5.0.5}: A High-Performance, Interoperable Lanczos-based Solver for generic Quantum Impurity Models\\
}
}
}
\end{center}
