...
\definecolor{bg-offwhite}{RGB}{255,255,242}%  \color{xkcdOffWhite}--
...
\lstdefinestyle{fstyle}{
  ...
  xleftmargin=1pt,
  xrightmargin=1pt,
  backgroundcolor=\color{bg-offwhite}, %\color{xkcdOffWhite},
...
\lstdefinestyle{mypython}{
  ...
  % xleftmargin=3.4pt,
  % xrightmargin=3.4pt,
  backgroundcolor=\color{bg-gray}, %\color{xkcdOffWhite},
