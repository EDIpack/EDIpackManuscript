...
\definecolor{background-color}{rgb}{0.1,0.1,0.1}
...
Flexible and interoperable high-performance Lanczos-based solver for generic Quantum Impurity problems: upgrading EDIpack.\\
}
}
}
\end{center}
...
%
  \newcommand{\CNRIOM}{CNR-IOM, Istituto Officina dei Materiali,
  Consiglio Nazionale delle Ricerche, Via Bonomea 265, Trieste, Italy}
\newcommand{\SISSA}{Scuola Internazionale Superiore di Studi Avanzati,
  Via Bonomea 265, Trieste, Italy}
\newcommand{\ITPHamburg}{I. Institut f\"ur Theoretische Physik,
  University of Hamburg, Notkestra\ss e 9, Hamburg, Germany}
\newcommand{\WZBURG}{Institut f\"ur Theoretische Physik und
...
\newcommand{\Geneve}{Department of Quantum Matter Physics, University of
  Geneva, Quai Ernest-Ansermet 24, Geneva, Switzerland}
\newcommand{\UPISA}{Department of Physics ``E. Fermi'' University of
