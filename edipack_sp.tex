...
\lstdefinelanguage{Monicelli}%
  {morekeywords={vaffanzum,ha clacsonato,più,meno,per,diviso,maggiore,minore,scappellamento,come fosse,Necchi,Mascetti,Perozzi,Melandri,Sassaroli,voglio,posterdati,mi porga,stuzzica,"brematura anche",che cos'è, o magari, o tarapia, il genio,"blinda la supercazzola",brematurata la supercazzola, avvertite},%
   sensitive=true,%
   alsoother={\$},%
   morecomment=[l]\#,%
   morecomment=[n]{\#=}{=\#},%
