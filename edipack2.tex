...
\section{Structure}\label{SecStruct}
\subsection{EDIpack2}
\subsection{EDIpack2ineq}
\subsection{EDIpack2 C-bindings}
...
\subsection{Reduced impurity density matrix}

\subsection{Bath parametrization}

\subsection{Bath Optimization}
