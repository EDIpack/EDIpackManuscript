...
to the solution of quantum impurity problems using different methods \cite{Bulla2008RMP,Parcollet2015CPC,Seth2016CPC,Bauernfeind2017PRX,Ganahl2015PRB,Mejuto_Bath_ASCI-DMFT,...}Unfinished list of references
poses a serious challenge to test accuracy and reliability of the
results.
As such, complex software packages are expected to develop a higher level of interoperability, i.e. the capability to operate with other software, possibly written in different programming languages.
...
\end{itemize}
and analogous functions for the inequivalent impurities case, i.e. EDIpack2Ineq. All functions are listed and thorougly documented in the online manual.
...
\paragraph{Anaconda.}
Similarly to \NAME, the Python API in EDIpack2py is available as an
Anaconda package for GNU/Linux and macOS systems. Packages are available for
Python version 3.10 and newer. The \NAME package contains the {\tt
...
input array there including inequivalent impurities support. Not sure what is meant here
